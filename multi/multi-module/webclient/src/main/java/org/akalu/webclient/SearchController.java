...
public class SearchController {
	...
	public String showResultPage1(
			@Valid @ModelAttribute("searchmodelattr") Dob dob,BindingResult bindingResult1,
			@ModelAttribute("searchmodelattr2") Dob2 dob2,
			ModelMap model) {
	...
	public String showResultPage2(
			@ModelAttribute("searchmodelattr") Dob dob,
			@Valid @ModelAttribute("searchmodelattr2") Dob2 dob2,	BindingResult bindingResult2,
			ModelMap model) {
