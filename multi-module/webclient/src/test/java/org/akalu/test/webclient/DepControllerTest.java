...
public class DepControllerTest {
	...
	public void testaddDepartmentPage1() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post(LocalURI.DEP_DIR + LocalURI.ADD_DEP);
	...
	public void testshowEditDepartmentPage() throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get(LocalURI.DEP_DIR + LocalURI.EDIT_DEP).param("id",
				"1");
	...
	public void testshowEditDepartmentPage2() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post(LocalURI.DEP_DIR + LocalURI.UPDATE_DEP);
