...
/**
 * This class tests all methods of DataController class using mock object technique.
 * MockMvc object play role of MVC infrastructure with established behavior. 
 * The main class to test - DataController - injected as mock {@code dataController}.
 * 
 * <p>All tests mostly functional by  nature to the exclusion of the methods
...
public class DataControllerTest {
    ...
    public void test404() throws Exception {
      ...
      mockMvc.perform(get("/dep/nopage"))
    ...
    /**
     * 
     * Test request with wrong parameter
     * 
     * @throws Exception
     */
    @Test
    public void test400() throws Exception {
        mockMvc.perform(get(DataURI.GET_DEP).param("id", "_s@d41~%"))
        .andExpect(status().isBadRequest());
    }

    /**
     * 
     * Test request with omitted mandatory parameter
     * 
     * @throws Exception
     */
    ...
    public void test400v2() throws Exception {
        mockMvc.perform(get(DataURI.DELETE_DEP))
        .andExpect(status().isBadRequest());
    }
    ...
    public void testGetDepartmentDetail() throws Exception {
      ...
      mockMvc.perform(get(DataURI.GET_DEP).param("id", "1"))
    ...
    public void testgetDepartmentsList() throws Exception {
        mockMvc.perform(get(DataURI.GET_LIST_DEP).param("f", "1").param("n", "1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void testgetEmployeesList() throws Exception {
        mockMvc.perform(get(DataURI.GET_LIST_EMPL)
        		.param("f", "0").param("n", "1").param("id", "1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(jsonPath("$").isNotEmpty())
    ...
    /**
     * 
     * In this method some classes from jackson-databind package are used.
     * In particularly, ObjectMapper - for creating mock JSON request from objects.
     * 
     * 
     * 
     * @throws Exception
    ...
    public void testgetSearchList() throws Exception {
        ...
        mockMvc.perform(post(DataURI.SEARCH_EMPL)
    ...
    public void testDeleteDepartment() throws Exception {
        mockMvc.perform(get(DataURI.DELETE_DEP).param("id", "1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
...
//        System.out.println(requestJSON);
        ...
        mockMvc.perform(post(DataURI.UPDATE_DEP).param("new", "true")
        		.contentType(MediaType.APPLICATION_JSON_VALUE).content(requestJSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void testDeleteEmployee() throws Exception {
        mockMvc.perform(get(DataURI.DELETE_EMPL).param("id", "0"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(jsonPath("$").isBoolean())
        .andExpect(jsonPath("$").value(true)); 
    ...
    public void testgetEmployeeDetail() throws Exception {
        mockMvc.perform(get(DataURI.GET_EMPL).param("id", "0"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(jsonPath("$").isNotEmpty())
    ...
    public void testUpdateEmployee() throws Exception {
        ...
        mockMvc.perform(post(DataURI.UPDATE_EMPL).param("new", "true")
        		.contentType(MediaType.APPLICATION_JSON_VALUE).content(requestJSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(jsonPath("$").isNumber())
    ...
    @Test
    public void testGetDepartmentSize() throws Exception {
        mockMvc.perform(get(DataURI.DEP_DIR))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(jsonPath("$").isNumber())
        .andExpect(jsonPath("$").value(1)); 
    ...
    @Test
    public void testGetEmployeeSize() throws Exception {
        mockMvc.perform(get(DataURI.EMPL_DIR).param("id", "1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(jsonPath("$").isNumber())
        .andExpect(jsonPath("$").value(1)); 
