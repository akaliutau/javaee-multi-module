...
public ModelAndView showAddEmployeePage() {
	...
	Long did = 0L;
	if (!lst.isEmpty()) did = lst.get(0).getId();
...
public String addEmployeePage(@Valid @ModelAttribute("emplmodelattr") Employee em, 
...
public String showEditEmployeePage(@Valid @ModelAttribute("emplmodelattr") Employee e, 
		BindingResult bindingResult, ModelMap model) {
