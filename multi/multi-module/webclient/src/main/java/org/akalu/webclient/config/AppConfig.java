...
/*
@Bean(name="dataServerSource")
public DataServerSource getdataServerSource(){
	return new DataServerSource(env.getProperty("ServerBaseURI"), env.getProperty("ServerName"));
}
*/
