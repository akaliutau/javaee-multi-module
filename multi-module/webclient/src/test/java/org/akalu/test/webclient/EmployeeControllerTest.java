...
public class EmployeeControllerTest {
	...
	public void test404() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post(LocalURI.EMPL_DIR);
	...
	public void testaddEmployeePage1() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post(LocalURI.EMPL_DIR + LocalURI.ADD_EMPL);
	...
	public void testshowEditEmployeePage() throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get(LocalURI.EMPL_DIR + LocalURI.EDIT_EMPL).param("id",
				"1");
	...
	public void testshowEditEmployeePage2() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post(LocalURI.EMPL_DIR + LocalURI.UPDATE_EMPL);
