...
/**
 * This class contains the simple tests for PageDescriptor class. The standard
 * JUnit testing techniques are used.
 * <p>
 * Almost all tests presented here test the edge constraints.
 * 
...
public class PageDescriptorTest {
	...
	/**
	 * Testing constraints for goNext() method (next page do not exists, on the
	 * current there are only 2 (=5-3) records)
	 * 
	 */
	...
	/**
	 * Testing constraints for goPrevious() method (previous page do exists with
	 * only 1 record, on the current there are 3 records) Method must set
	 * <first> field to 0.
	 * 
	 */
	@Test
